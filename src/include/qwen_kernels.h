...
void qk_embed_gather(float* out, const float* embed, const int* ids, int L, int H,cudaStream_t stream = 0);
void qk_rmsnorm(float* out, const float* in, const float* w, int L, int H, float eps,cudaStream_t stream = 0);
void qk_add_bias(float* x, const float* bias, int L, int N,cudaStream_t stream = 0);
void qk_add_residual(float* x, const float* y, int n,cudaStream_t stream = 0);
void qk_rope(float* x, int L, int n_heads, int D, int pos_base, float theta,cudaStream_t stream = 0);
void qk_silu_mul(float* out, const float* gate, const float* up, int n,cudaStream_t stream = 0);
...
void qkcuda_rope(float* x, int L, int n_heads, int D, int* pos_base, float theta,cudaStream_t stream = 0);
